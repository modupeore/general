...
# TABLE VARIABLES
my ($lib_id, $total, $mapped, $unmapped, $deletions, $insertions, $junctions, $ISOFORMS, $isoforms, $prep, $date); #RESULTS_SUMMARY TABLE
my ($raw_reads, $fastqc, $accepted, $unmapped_bam, $deletions_bed, $insertions_bed, $junctions_bed, $skipped_gtf, $transcripts_gtf, $isoforms_fpkm, $ISOFORMS_FPKM, $run_log); #ACTUAL_FILES TABLE
my ($track, $class, $ref_id, $gene, $gene_name, $tss, $locus, $chrom_no, $chrom_start, $chrom_stop, $length, $coverage, $fpkm, $fpkm_low, $fpkm_high, $fpkm_stat); # ISOFORMS_FPKM & ISOFORMS_FPKM TABLE
...
#  	72,73,774,79,807,808,809,80,810,811,
#  	814,819,81,825,826,827,828,82,834,836,
#  	839,83,841,842,843,844,845,846,84,863,
#  	864,865,867,868,869,879,880,881,883,884,
# 	
	# 13785.pts-1.raven
#  	886,894,895,897,899,900,901,903,912,913,
#  	914,915,917,918,919,921,925,926,927,928,
#  	931,932,933,935,936,955,956,957,958,95,
#  	960,973,974,976,977,979,981,983,984,986,
#  	987,98,990,992,993,994,997,99
);
...
foreach my $spec (@newarray){
	...
	my $outfile = "/home/modupe/isoformsfpkm/$spec"."isoforms.fpkm_tracking";
	open(ISOFORMS, "<$outfile") or die "Can't open file $outfile\n";
	$lib_id = $spec."DE";
...
# $syntax = "select  fpkm, tracking_id, gene_id, chrom_no from ISOFORMS_FPKM where fpkm >= 99999.99999 and library_id like \'$lib_id\'";
